...
lineaX = threading.Thread(target=crearAnimacion, args=(10,10,'X',))
lineaY = threading.Thread(target=crearAnimacion, args=(10,30,'Y',))
lineaZ = threading.Thread(target=crearAnimacion, args=(10,50,'Z',))
