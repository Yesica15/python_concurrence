...
if __name__ == '__main__':
    lineaX = multiprocessing.Process(target=crearAnimacion, args=(10,10,'X',))
    lineaY = multiprocessing.Process(target=crearAnimacion, args=(10,30,'Y',))
    lineaZ = multiprocessing.Process(target=crearAnimacion, args=(10,50,'Z',))
